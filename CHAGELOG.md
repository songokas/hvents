...
- ability to define events using gherkin (check examples/)
- define initial state using configuration
- handlebars helper: concat

### Changed

- bump package versions
- scheme json is using local url
...
- datetime parsing library upgrade
- optional features introduced
